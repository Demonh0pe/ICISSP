...
%% ---------------------------------------------------------
%% [3] Introduction —— contributions 新增一条
...
%% 作为该小节最后一段,接在 “…erases still-relevant signal.” 之后。
%% ---------------------------------------------------------
...
%% ---------------------------------------------------------
%% [11] sec:disc-limitations —— 新增 6 段
%% Metric definition 接在 Metric and granularity 之后;Architecture coverage 替换原 Single architecture 段,后跟 Rebuilt corpus、Untuned hyperparameters、Replication breadth;Input truncation 接在 Pretraining contamination 之后。
%% ---------------------------------------------------------
