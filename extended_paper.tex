...
%%     and~\ref{tab:cross-arch-ibr}); a three-point sweep of the rehearsal
%%     budget (Sec.~\ref{sec:buffer}, Tab.~\ref{tab:buffer}); expanded
%%     threats and future work; and the "Differences from the Conference
%%     Version" subsection (Sec.~\ref{sec:differences}, requirement 6).
%%
